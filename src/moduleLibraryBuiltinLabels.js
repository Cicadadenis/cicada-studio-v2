/** Built-in module library labels (en/uk). Categories keyed by Russian label from ModuleLibrary.jsx */
...
export const LIBRARY_MODULE_LABELS = {
  en: {
    ...
    "example_echo": { name: "\ud83d\udd04 Echo Bot", desc: "Simple bot that echoes user messages" },
    "example_weather": { name: "\u2600\ufe0f Weather Bot", desc: "Shows weather in selected city via wttr.in API" },
    "example_shop": { name: "\ud83d\udecd\ufe0f Shop Bot", desc: "Simple shop with catalog, cart and checkout" },
    "example_full": { name: "\u26a1 All Features", desc: "Demo bot with all main Cicada DSL features" },
    "tg_document_echo": { name: "Document echo to user", desc: "Receive doc, save file_id, send back" },
    "tg_media_moderation": { name: "Media moderation", desc: "Forward photos and docs to admin for review" },
  ...
  uk: {
    ...
    "example_echo": { name: "\ud83d\udd04 Ехо Бот", desc: "Простий бот, що повторює повідомлення" },
    "example_weather": { name: "\u2600\ufe0f Бот погоди", desc: "Показує погоду через wttr.in API" },
    "example_shop": { name: "\ud83d\udecd\ufe0f Магазин Бот", desc: "Каталог, кошик та оформлення замовлення" },
    "example_full": { name: "\u26a1 Усі функції", desc: "Демо-бот з усіма функціями Cicada DSL" },
    "tg_document_echo": { name: "Документ назад юзеру", desc: "Прийняти документ, зберегти file_id, відправити" },
    "tg_media_moderation": { name: "Модерація медіа", desc: "Пересилка фото та файлів адміну" },
